...
Ext.define('Travice.view.dialog.ReportConfigController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.reportConfig',

    requires: [
        'Travice.store.ReportEventTypes',
        'Travice.store.AllNotifications'
    ],
    ...
    onSaveClick: function (button) {
        ...
        if (eventType.indexOf(Travice.store.ReportEventTypes.allEvents) > -1) {
            eventType = [Travice.store.ReportEventTypes.allEvents];
