...
Ext.define('Travice.model.Event', {
        ...
        convert: function (v, rec) {
            ...
            if (rec.get('type') === 'commandResult') {
                ...
                text = Strings.eventDriverChanged + ': ' +
                    Travice.AttributeFormatter.driverUniqueIdFormatter(rec.get('attributes')['driverUniqueId']);
            } else {
                text = Travice.app.getEventString(rec.get('type'));
            }
