...
Ext.define('Travice.store.CoordinateFormats', {
    ...
    formatValue: function (key, value, unit) {
        ...
        switch (unit) {
            case 'ddm':
                ...
                return degrees + '° ' + minutes.toFixed(Travice.Style.coordinatePrecision) + '\' ' + hemisphere;
            case 'dms':
                value = Math.abs(value);
                degrees = Math.floor(value);
            ...
            default:
                return value.toFixed(Travice.Style.coordinatePrecision) + '°';
        }
    }
});
