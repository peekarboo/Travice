...
Ext.define('Travice.view.CustomNumberField', {
            ...
            switch (config.dataType) {
                case 'speed':
                    ...
                    config.units.getValue = function () {
                        return Travice.app.getAttributePreference('speedUnit', 'kn');
                    };
                ...
                case 'distance':
                    ...
                    config.units.getValue = function () {
                        return Travice.app.getAttributePreference('distanceUnit', 'km');
                    };
